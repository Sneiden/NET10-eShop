    ...
    public class OrderConfiguration : IEntityTypeConfiguration<Order>
    {
        public void Configure(EntityTypeBuilder<Order> builder)
        {
            ...
            builder.ComplexProperty(
                ...
                {
                    BillingaddressBuilder.Property(ba => ba.FirstName)
                        .HasMaxLength(50)
                        .IsRequired();

                    BillingaddressBuilder.Property(ba => ba.LastName)
                        .HasMaxLength(50)
                        .IsRequired();

                    BillingaddressBuilder.Property(ba => ba.EmailAddress)
                        .HasMaxLength(50);

                    BillingaddressBuilder.Property(ba => ba.AddressLine)
                        .HasMaxLength(180)
                        .IsRequired();

                    BillingaddressBuilder.Property(ba => ba.Country)
                        .HasMaxLength(50);

                    BillingaddressBuilder.Property(ba => ba.State)
                        .HasMaxLength(50);

                    BillingaddressBuilder.Property(ba => ba.ZipCode)
                        .HasMaxLength(5)
                        .IsRequired();
                });
